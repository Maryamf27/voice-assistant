...
export const IconEye = (p: IconProps) => base(<><path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12Z" /><circle cx="12" cy="12" r="3" /></>, p);
export const IconEyeOff = (p: IconProps) => base(<><path d="M3 3l18 18" /><path d="M10.6 5.7A10.6 10.6 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17.5 17.5 0 0 1-3.1 4M6.6 6.6C3.9 8.3 2.5 12 2.5 12S6 18.5 12 18.5a9.9 9.9 0 0 0 4.2-.9" /><path d="M9.9 10.1a3 3 0 0 0 4.2 4.2" /></>, p);
