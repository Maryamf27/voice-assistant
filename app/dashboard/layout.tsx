          ...
          <div className="flex min-w-0 min-h-0 flex-1 flex-col">
            <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-base-border bg-base-bg/85 px-4 backdrop-blur-md md:px-8">
              ...
              <div className="ml-auto flex min-w-0 items-center gap-2 sm:gap-3">
                ...
                <span className={`inline-flex shrink-0 items-center rounded-full border px-2.5 py-1 text-[11px] font-semibold tracking-wide ${isPremium ? "border-amber-300/30 bg-amber-300/10 text-amber-200" : "border-base-border bg-base-surface text-ink-muted"}`}>
